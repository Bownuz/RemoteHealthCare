...
{
    public class StopTrainingAction : DoctorState
    {
        private ServerConnection serverConnection;
        private ClientenForm form;

        public StopTrainingAction(DoctorProtocol protocol, ClientenForm form, ServerConnection serverConnection) : base(protocol, form, serverConnection)
        {
